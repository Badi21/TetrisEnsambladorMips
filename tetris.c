...
/* Sincronizada con ../tetris.c:3150 */
...
Imagen pantalla_buffer;
Imagen campo_buffer;
Imagen pieza_actual_buffer;
Imagen imagen_auxiliar_buffer;
Imagen *const pantalla = &pantalla_buffer;
Imagen *const campo = &campo_buffer;
Imagen *const pieza_actual = &pieza_actual_buffer;
Imagen *const imagen_auxiliar = &imagen_auxiliar_buffer;
int pieza_actual_x;
int pieza_actual_y;
bool acabar_partida;
